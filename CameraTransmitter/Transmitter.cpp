...
void Transmitter::transmitFrame(QByteArray& frame_encoded){
    ...
    transmitDatagram(header_frame);

    qint32 cur_offset = 0;
    QByteArray datagram;
    while (cur_offset + static_cast<qint32>(max_size_datagram) < frame_encoded.size()) {
